...
namabot = 'HERMAN BOTZ' //ganti nama bot kamu
cr = '*「 HERMAN BOT 」*' //ganti nama bot
faketoko = "Herman-Botz" //ganti nama bot
lolkey = 'e3d6805ea05cefd5b8fc3a9c' //apiknya ya sayang
zeksapi = 'Ardy-ApiKey' //free apikey
/******** OWNER NUMBER**********/

const ownerNumber = ["6283146208804@s.whatsapp.net"]   //ganti nomor kamu sayang
...
break
		...
		case 'request':
					...
					client.sendMessage('6283146208804@s.whatsapp.net', options, text, {quoted: fharga})
					client.sendMessage('6283146208804@s.whatsapp.net', options, text, {quoted: fharga})
					reply('REQUEST ANDA TELAH SAMPAI KE OWNER HERMAN BOTZ REQUESTS PALSU ATAU MAIN² TIDAK AKAN DITANGGAPI.')
					break
		case 'blocklist': 
...
───────────────────────
◯ *PEMBAYARAN*
VIA PULSA : 083146208804
VIA DANA : 083146208804
VIA GOPAY : SCAM KODE DI ATAS
───────────────────────
◯ *KEUNTUNGAN SEWA BOT :*
...
break
		...
		case 'bc': 
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							client.sendMessage(_.jid, buff, image, {caption: `*「 HERMAN BOTZ BROADCAST 」*\n\n${body.slice(4)}`})
						}
		...
		case 'group':
            ...
            case 'developer':
                  ...
                  client.sendMessage(from, 'Tuh nomer owner Herman Botz Jangan di spam -_ ',MessageType.text, { quoted: mek} )
                  client.sendMessage(from, duingz, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true} )
					break    
           case 'setname':
					if (!isGroup) return reply(ind.groupo())
