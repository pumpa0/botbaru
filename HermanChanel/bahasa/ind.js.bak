...
exports.bug = () => {
	return`*Masalah telah di laporkan ke owner GUSTIツ, Laporan palsu atau main² tidak akan ditanggapi.*`
}
...
exports.registered = (namaUser, umurUser, serialUser, time, sender) => {
	return`*「 DATABASE ${namabot} 」*\n\nkamu sudah terdaftar dengan data \n\n┏━⊱nama\n┗⊱${namaUser}\n┏━⊱nomer\n┗⊱wa.me/${sender.split("@")[0]}\n┏━⊱umur\n┗⊱${umurUser}\n┏━⊱waktu pendaftaran\n┗⊱${time}\n\n┏━❉ *NS* ❉━\n┣⊱${serialUser}\n┗⊱NOTE : JANGAN LUPA SUBSCRIBE : https://youtube.com/channel/UC215JXrs2SwZGF7cvROKeVA
`
}
